...
As research disciplines and outputs are so varied there is no set step-by-step guide to carrying out a metrics analysis. Instead, there are a set of principles that should be followed[:]{.underline} Transparency, Appropriateness, Equality, Reproducible and Continual Reassessment.
